...
// Javob:Kodini yozib bering
// let harflar = ["a", "b", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "x", "y", "z"];
// let ism = harflar[0]+harflar[9]+harflar[16]+harflar[13]+harflar[11]
// console.log(ism)
...
// Javob:Kodini yozib bering
// let age = confirm("Yoshingiz 18 yoshdami?")
// alert(age)
...
// const userInput = prompt("Ismingizni kiriting:");
// if (userInput) {
//     alert("Teskari ism: " + reverseString(userInput));
// }
